...
public class AddPetToStoreWithLombok_And_DataProvider {
    ...
    // All the data type coming from the Excel file is String, So, all the Method arguments are String
    public void addPetWithDataProvider(String petId, String categoryId, String categoryName, String petName, String photoUrl, String tagId, String tagName, String petStatus){
        ...
        AddAPet addAPet = AddAPet
                ...
                .category(category)
                .name(petName)
                .photoUrl(Arrays.asList(photoUrl))
